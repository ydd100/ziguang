package com.ruoyi.project.userbackground.columnData.mapper;
 ...
 * @date 2021-09-05
 */
public interface CpColumnDataMapper 
{
    /**
     * 查询测评表格-列
     * 
     ...
     * 批量删除测评表格-列
     * 
     * @param columnDataIds 需要删除的数据主键集合
     * @return 结果
     */
     ...
     * @return
     */
    public Map<String,Long> selectMaxSortGroupBySheetId(Long sheetId);
