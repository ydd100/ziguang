...
$(function() {
    ...
    function refreshTab() {
    	...
    	$('.RuoYi_iframe[data-panel="' + currentId + '"]').remove();
        var url = target.attr('src');
    	target.attr('style','').attr('src', url).ready();
    }
        ...
        items: {
            ...
            "refresh": {
                ...
                callback: function(key, opt) {
                    setActiveTab(this);
                    var target = $('.RuoYi_iframe[data-id="' + this.data('id') + '"]');
                    $('.RuoYi_iframe[data-panel="' + this.data('id') + '"]').remove();
                    var url = target.attr('src');
                    $.modal.loading("数据加载中，请稍后...");
                    target.attr('style','').attr('src', url).on('load', function() {
                    	$.modal.closeLoading();
                    });
                }
            },
